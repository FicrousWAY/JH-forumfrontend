  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'sections', name: 'sections', component: () => import('@/views/sections-view.vue') },
        { path: 'messages', name: 'messages', component: () => import('@/views/messages-view.vue') },
        { path: 'me', name: 'me', component: () => import('@/views/me-view.vue') },
      ],
    },
  ],
})
